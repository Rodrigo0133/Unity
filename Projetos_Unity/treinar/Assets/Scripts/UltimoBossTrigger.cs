...
public class UltimoBossTrigger : MonoBehaviour
{
    [Header("Configuracoes")]
    public UltimoBoss boss;
    ...
    private void VerificarBloqueioInicial()
    {
        ...
        {
            Debug.Log("[UltimoBossTrigger] Todas as baratas morreram. A entrada abriu.");
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            jaAtivado = true;
            Debug.Log("[UltimoBossTrigger] Jogador entrou na sala. A luta vai comecar.");
    ...
    private IEnumerator IniciarLutaRoutine()
    {
        ...
        if (boss != null)
            ...
            Debug.LogWarning("[UltimoBossTrigger] Boss nao referenciado no Inspector.");
    ...
    private void TrancarPorta()
    {
        if (meuCollider != null)
        {
            ...
            meuCollider.isTrigger = false;
            Debug.Log("[UltimoBossTrigger] Porta trancada atras do jogador.");
        }
    }
