...
public class BossBarataTrigger : MonoBehaviour
{
    ...
    private void VerificarBloqueioInicial()
    {
        ...
        {
            Debug.Log("[BossBarataTrigger] Todas as baratas morreram. A entrada abriu.");
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            jaAtivado = true;
            Debug.Log("[BossBarataTrigger] Jogador entrou na sala. A luta vai comecar.");
    ...
    private IEnumerator IniciarLutaRoutine()
    {
        ...
        if (boss != null)
            ...
            Debug.LogWarning("[BossBarataTrigger] Boss nao referenciado no Inspector.");
    ...
    private void TrancarPorta()
    {
        if (meuCollider != null)
        {
            ...
            meuCollider.isTrigger = false;
            Debug.Log("[BossBarataTrigger] Porta trancada atras do jogador.");
        }
    }
