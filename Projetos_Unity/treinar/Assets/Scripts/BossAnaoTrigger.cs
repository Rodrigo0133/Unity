...
public class BossAnaoTrigger : MonoBehaviour
{
    [Header("Configuracoes")]
    public BossAnaoMitologico boss;
    ...
    private void VerificarBloqueioInicial()
    {
        ...
        {
            Debug.Log("[BossAnaoTrigger] Todas as baratas morreram. A entrada abriu.");
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            jaAtivado = true;
            Debug.Log("[BossAnaoTrigger] Jogador entrou na sala. A luta vai comecar.");
    ...
    private IEnumerator IniciarLutaRoutine()
    {
        ...
        if (boss != null)
            ...
            Debug.LogWarning("[BossAnaoTrigger] Boss nao referenciado no Inspector.");
    ...
    private void TrancarPorta()
    {
        if (meuCollider != null)
        {
            ...
            meuCollider.isTrigger = false;
            Debug.Log("[BossAnaoTrigger] Porta trancada atras do jogador.");
        }
    }
